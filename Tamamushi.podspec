#
#  Be sure to run `pod spec lint Tamamushi.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "makomori"
  # s.authors            = { "makomori" => "makomori26@gmail.com" }
  # s.social_media_url   = "http://twitter.com/makomori"
